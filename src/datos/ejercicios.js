...
export const EJERCICIOS = [
  ...
  ej("a2", "TORSO A", 2, "Elevación lateral en máquina", "4×12-20", { series: 4, min: 12, max: 20, estrella: true, aislado: true, tecnica: "Va la segunda a propósito: es tu prioridad nº1 y aquí progresas más.", ultima: ULTIMA_AISLADO, mus: ["hombroLateral"] }),
  ej("a3", "TORSO A", 3, "Press inclinado en máquina", "3×8-12", { series: 3, min: 8, max: 12, mus: ["pecho"], sec: ["hombroAnterior", "triceps"] }),
  ...
  // ---------------- PIERNA A ----------------
  ej("c1", "PIERNA A", 1, "Hack squat en máquina", "3×8-12", { series: 3, min: 8, max: 12, mus: ["cuadriceps", "gluteo"] }),
  ...
  ej("c6", "PIERNA A", 6, "Gemelos en máquina", "3×10-20", { series: 3, min: 10, max: 20, aislado: true, tecnica: "Rodilla recta: trabaja el gemelo.", mus: ["gemelo"] }),
  // Fuerza protectora del plan de carrera: sóleo y tibial blindan la espinilla.
  ej("c7", "PIERNA A", 7, "Sóleo (gemelo sentado)", "3×12-15", { series: 3, min: 12, max: 15, estrella: true, aislado: true, tecnica: "Rodilla flexionada: el sóleo absorbe el impacto de correr.", mus: ["gemelo"] }),
  ...
  ej("c9", "PIERNA A", 9, "Elevación lateral en máquina", "3×12-20", { series: 3, min: 12, max: 20, estrella: true, aislado: true, ultima: ULTIMA_AISLADO, mus: ["hombroLateral"] }),
  ...
  ej("b1", "TORSO B", 1, "Press plano en máquina", "3×8-12", { series: 3, min: 8, max: 12, mus: ["pecho"], sec: ["hombroAnterior", "triceps"] }),
  ej("b2", "TORSO B", 2, "Elevación lateral en máquina", "4×12-20", { series: 4, min: 12, max: 20, estrella: true, aislado: true, tecnica: "Va la segunda a propósito: es tu prioridad nº1 y aquí progresas más.", ultima: ULTIMA_AISLADO, mus: ["hombroLateral"] }),
  ...
  ej("d2", "PIERNA B", 2, "Prensa", "3×8-12", { series: 3, min: 8, max: 12, mus: ["cuadriceps"], sec: ["gluteo"] }),
  ...
  ej("d6", "PIERNA B", 6, "Gemelos en máquina", "3×10-20", { series: 3, min: 10, max: 20, aislado: true, tecnica: "Rodilla recta: trabaja el gemelo.", mus: ["gemelo"] }),
  // Fuerza protectora del plan de carrera: sóleo y tibial blindan la espinilla.
  ej("d7", "PIERNA B", 7, "Sóleo (gemelo sentado)", "3×12-15", { series: 3, min: 12, max: 15, estrella: true, aislado: true, tecnica: "Rodilla flexionada: el sóleo absorbe el impacto de correr.", mus: ["gemelo"] }),
  ...
  ej("d9", "PIERNA B", 9, "Elevación lateral en máquina", "3×12-20", { series: 3, min: 12, max: 20, estrella: true, aislado: true, ultima: ULTIMA_AISLADO, mus: ["hombroLateral"] }),
